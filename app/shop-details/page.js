        ...
        <>
            <Layout headerStyle={3} footerStyle={1} breadcrumbTitle="Shop Details">
                <div>
                    ...
                    {newFunction_1(handleOnClick, activeIndex)}
...
function newFunction_2() {
    return <div className="col-lg-5 col-md-7">
...
function newFunction_1(handleOnClick, activeIndex) {
    return <div className="product-details-area">
        <div className="container">
            <div className="row">
...
function newFunction() {
    return <div className="col-lg-2 col-md-5">
